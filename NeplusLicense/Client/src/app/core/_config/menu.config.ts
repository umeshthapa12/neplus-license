            ...
            items: [
                {
                    ...
                    submenu: [
                        {
                            title: 'ड्यासबोर्ड',
                            page: '/main/dartachalani/dashboard',
                        },
                        {
                            title: 'दर्ता',
                            page: '/main/dartachalani/darta',
                        },
                        {
                            title: 'चलानी',
                            page: '/main/dartachalani/chalani',
                        },
                    ]
                },
                {
                    ...
                    submenu: [
                        {
                            title: 'ड्यासबोर्ड',
                            page: '/main/beruju/dashboard',
                        },
                        {
                            title: 'बेरुजु',
                            page: '/main/beruju/beruju-list',
                        },
                        {
                            title: 'फर्छ्यौट',
                            page: '/main/beruju/persuade',
                        },
                        {
                            title: 'बेरुजु दफा',
                            page: '/main/beruju/section-beruju',
                        },
                        {
                            title: 'रिपोर्ट',
                            root: true,
                            ...
                            submenu: [
                                {
                                    title: 'बेरुजु रिपोर्ट',
                                    page: '/main/beruju/report-beruju',
                                },
                                {
                                    title: 'बेरुजु संपरीक्षण',
                                    page: '/main/beruju/audit-beruju',
                                },
                            ]
                        },
                        {
                            title: 'आर्थिक वर्ष',
                            page: '/main/beruju/fiscal-year',
                        },
                        {
                            title: 'कार्यालय',
                            page: '/main/beruju/office',
                        },
                    ]
