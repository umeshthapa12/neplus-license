...
export class AuthComponent implements OnInit {
    ...
    incompatibleBrowser = Diagnostic.userAgent().toLowerCase().search('ie') > -1;
    hasStorage = Diagnostic.storageAvailable('localStorage');
    isLatestVersion = Diagnostic.isLatestAppVersion();
